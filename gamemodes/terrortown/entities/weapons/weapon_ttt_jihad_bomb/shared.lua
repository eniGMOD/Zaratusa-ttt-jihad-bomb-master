...
if SERVER then
	...
	LANG.AddToLanguage("english", "jihad_bomb_desc", "For the ever-more passionate individual.\nYour 72 virgins await (Allegedly).\n\nNOTE: No refund after use.")
...
function SWEP:PrimaryAttack()
	...
	self:GetOwner():EmitSound("sound/weapons/jihad_bomb/ttt_never_surrender.wav", 400, math.random(100, 125))
